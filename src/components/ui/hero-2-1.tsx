      ...
      <div className="relative z-10">
          ...
          {mobileMenuOpen && (
            ...
            >
              ...
              <div className="mt-8 flex flex-col space-y-6">
                ...
                <MobileNavItem label="Skills" />
                <MobileNavItem label="Contact" />
                <div className="pt-4">
                  <button className="w-full justify-start border border-gray-700 text-white py-2">
                    View Resume
                  </button>
                </div>
                <button className="h-12 rounded-full bg-white px-8 text-base font-medium text-black hover:bg-white/90">
        ...
        <div className="container mx-auto mt-12 px-4 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-300">
            I craft responsive, dynamic, and beautiful web applications using modern technologies like React, Next.js, and Tailwind CSS.
          </p>
          <div className="mt-10 mb-20 flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
            <button className="h-12 rounded-full bg-white px-8 text-base font-medium text-black hover:bg-white/90">
              View My Work
            </button>

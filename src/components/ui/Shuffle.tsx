...
import { SplitText as GSAPSplitText } from 'gsap/dist/SplitText'; // often located in dist if trial or local, but we'll try the import from the prompt
import { useGSAP } from '@gsap/react';
import './Shuffle.css';

// We register plugins inside a check to avoid SSR issues
    ...
    () => {
      ...
      const build = () => {
        ...
        try {
          ...
          console.warn("GSAP SplitText is not available or failed to initialize.");
          setReady(true);
          return;
        }

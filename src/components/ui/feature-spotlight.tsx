    ...
    >
      ...
      <Link href={linkTo} className="block">
        ...
        >
            ...
            <div className="relative h-[280px] w-[260px] overflow-hidden sm:h-[320px] sm:w-[300px] md:h-[360px] md:w-[320px] lg:h-[420px] lg:w-[380px] border border-border/50">
            <div
            ...
            <img loading="lazy"
                src={imageSrc}
                alt={title1 + " " + title2}
                className="h-full w-full object-cover transition-all duration-1000 hover:scale-105 saturate-[1.2] contrast-[1.1]"
                style={{
                transform: isHovered ? "scale(1.03)" : "scale(1)",
                transitionTimingFunction: "cubic-bezier(0.16, 1, 0.3, 1)",
                filter: isHovered ? "saturate(1.4) contrast(1.1)" : "saturate(1.2) contrast(1.1)",
                }}
            />

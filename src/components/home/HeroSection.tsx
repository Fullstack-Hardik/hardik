    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto max-w-6xl px-4 text-center relative z-10">
        ...
        <div className="flex items-center justify-center gap-4 mb-16">
          {[
            { icon: <GithubIcon />, href: "https://github.com/fullstack-hardik", label: "GitHub" },
            { icon: <InstagramIcon />, href: "https://instagram.com/official_hardik_yadav", label: "Instagram" },
            { icon: <Mail className="w-5 h-5" />, href: "mailto:hardikyadaven@gmail.com", label: "Email" },
          ].map((s) => (
            <a
              key={s.label}
              href={s.href}
